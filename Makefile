...
$(kernel_object_files): build/%.o : src/%.c
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -ffreestanding $(patsubst build/%.o, src/%.c, $@) -o $@
...
build-x86_64: $(kernel_object_files) $(bootloader_asm_object_files)
	...
	x86_64-elf-ld -n -o dist/bootloader/kernel.bin -T targets/bootloader/linker.ld $(kernel_object_files) $(bootloader_asm_object_files) && \
